    ...
    return (
      <div>
        ...
        {this.state.emails.map(email => (
          <EmailItem key={email.mId} email={email} />
        ))}
      </div>
    ...
    emails : [
      {
        ...
        labelId: 1,
        from: 'Pratheek',
        subject: 'hello ashraf, kindly complete the project asap',
        time: "11:15"
      },
      {
        id: 1,
        labelId: 1,
        from: 'Shashidhar',
        subject: 'hi syed, I need your project for reference ',
        time: "22:08"
      },
      {
        id: 2,
